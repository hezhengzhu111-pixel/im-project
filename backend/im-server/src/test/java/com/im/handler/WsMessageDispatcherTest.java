...
class WsMessageDispatcherTest {
    ...
    void dispatch_NullOrBlankPayload_ShouldReturn() {
        assertEquals(WsMessageDispatcher.DispatchResult.EMPTY_PAYLOAD, dispatcher.dispatch(session, "123", null));
        assertEquals(WsMessageDispatcher.DispatchResult.EMPTY_PAYLOAD, dispatcher.dispatch(session, "123", "   "));
    ...
    void dispatch_PingMessage_ShouldDispatchToHeartbeatHandler() {
        ...
        assertEquals(WsMessageDispatcher.DispatchResult.HEARTBEAT_OK, dispatcher.dispatch(session, "123", "ping"));
    ...
    void dispatch_JsonMessage_ShouldParseAndDispatch() {
        ...
        assertEquals(WsMessageDispatcher.DispatchResult.BUSINESS_OK, dispatcher.dispatch(session, "123", payload));
    ...
    void dispatch_InvalidJson_ShouldCatchExceptionAndReturn() {
        ...
        assertEquals(WsMessageDispatcher.DispatchResult.INVALID_PAYLOAD, dispatcher.dispatch(session, "123", payload));
    ...
    void dispatch_NoMatchingHandler_ShouldReturn() {
        ...
        assertEquals(WsMessageDispatcher.DispatchResult.UNSUPPORTED_TYPE, dispatcher.dispatch(session, "123", payload));
