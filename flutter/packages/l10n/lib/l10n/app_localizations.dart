...
abstract class AppLocalizations {
  ...
  /// No description provided for @registerUserAgreementContent.
  ///
  /// In en, this message translates to:
  /// **'1. Terms of Service\nWelcome to the IM chat app. Please read and understand all terms of this agreement before using the service.\n\n2. User Responsibilities\nUsers must comply with applicable laws and regulations and must not use the service for illegal activities.\n\n3. Privacy Protection\nWe value user privacy and will protect personal information in accordance with the privacy policy.\n\n4. Service Changes\nWe reserve the right to modify or terminate the service at any time without prior notice.'**
  String get registerUserAgreementContent;

  /// No description provided for @registerPrivacyPolicyContent.
  ///
  /// In en, this message translates to:
  /// **'1. Information Collection\nWe only collect user information necessary to provide the service.\n\n2. Information Use\nCollected information is used only to provide and improve the service and will not be used for other purposes.\n\n3. Information Protection\nWe adopt industry-standard security measures to protect user information.\n\n4. Information Sharing\nExcept as required by law, we will not share user personal information with third parties.'**
  ...
  /// No description provided for @momentsNoMorePosts.
  ///
  /// In en, this message translates to:
  /// **'No more moments'**
  String get momentsNoMorePosts;

  /// No description provided for @momentsPostNotFound.
  ///
  /// In en, this message translates to:
  /// **'Post not found'**
  String get momentsPostNotFound;
  ...
  /// No description provided for @chatMembersLoadFailed.
  ///
  /// In en, this message translates to:
