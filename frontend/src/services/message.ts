...
export const messageService = {
  sendPrivate: (data: SendPrivateMessageRequest) =>
    http.post<Message>("/message/send/private", data),
  sendGroup: (data: SendGroupMessageRequest) =>
    http.post<Message>("/message/send/group", data),
  getPrivateHistory: (friendId: string, params: any) =>
    http.get<Message[]>(`/message/private/${friendId}`, { params }),
  ...
  getGroupHistory: (groupId: string, params: any) =>
    http.get<Message[]>(`/message/group/${groupId}`, { params }),
